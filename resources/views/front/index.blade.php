        ...
        <div class="container max-w-[1130px] mx-auto relative pt-10 z-10">
            ...
            <div id="Hero" class="flex flex-col gap-[30px] mt-20 pb-20">
                ...
                <div class="flex flex-col gap-[10px]">
                    <h1 class="font-extrabold text-[50px] leading-[65px] max-w-[536px]">Help Build Biggest <br> Dream From
                        Scratch</h1>
                    <p class="text-cp-light-grey leading-[30px] max-w-[437px]">Shayna is an award-winning construction
                        company with a team of skilled craftsmen and women who have over 100 years of combined experience.
                    </p>
                </div>
    ...
    <div id="OurPrinciples" class="container max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-20">
        ...
        <div class="flex flex-wrap items-center gap-[30px] justify-center">
            <div
                ...
                <div class="flex flex-col p-[0_30px_30px_30px] gap-5">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="leading-[30px] text-cp-light-grey">Shayna is an award-winning ametia construction company
                            with lorem</p>
                    </div>
            ...
            <div
                ...
                <div class="flex flex-col p-[0_30px_30px_30px] gap-5">
                    <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                        <img src="{{ asset('assets/icons/user-octagon.svg') }}" class="w-full h-full object-contain"
                            alt="icon">
                    </div>
                    <div class="flex flex-col gap-1">
            ...
            <div
                ...
                <div class="flex flex-col p-[0_30px_30px_30px] gap-5">
                    <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                        <img src="{{ asset('assets/icons/building-4.svg') }}" class="w-full h-full object-contain"
                            alt="icon">
                    </div>
                    <div class="flex flex-col gap-1">
                ...
                <div
                    ...
                    <div class="flex items-center justify-center gap-[10px]">
                        <div class="w-6 h-6 flex shrink-0">
                            <img src="{{ asset('assets/photos/photo1.png') }}" alt="icon">
                        </div>
                ...
                <div class="testimonial-container flex flex-col gap-[112px] w-[565px]">
                    <div class="flex flex-col gap-[30px]">
                        ...
                        <div class="relative pt-[27px] pl-[30px]">
                            ...
                            <p class="font-semibold text-2xl leading-[46px] relative z-10">Shayna is a leading construction
                                company in Melbourne, building new homes and commercial projects that are durable,
                                functional and beautiful.</p>
                        </div>
                        <div class="flex items-center justify-between pl-[30px]">
                            <div class="flex items-center gap-6">
                                <div class="w-[60px] h-[60px] flex shrink-0 rounded-full overflow-hidden">
                                    <img src="{{ asset('assets/icons/quote.svg') }}" class="w-full h-full object-cover"
                                        alt="photo">
                                </div>
            ...
            <div
                ...
                <div class="testimonial-container flex flex-col gap-[112px] w-[565px]">
                    <div class="flex flex-col gap-[30px]">
                        ...
                        <div class="relative pt-[27px] pl-[30px]">
                            <div class="absolute top-0 left-0">
                                <img src="{{ asset('assets/logo/logo-51.svg') }}" alt="icon">
                            </div>
                        ...
                        <div class="flex items-center justify-between pl-[30px]">
                            <div class="flex items-center gap-6">
                                <div class="w-[60px] h-[60px] flex shrink-0 rounded-full overflow-hidden">
                                    <img src="{{ asset('assets/logo/logo-51.svg') }}" class="w-full h-full object-cover"
                                        alt="photo">
                                </div>
                                <div class="flex flex-col justify-center gap-1">
            ...
            <div
                ...
                <div class="testimonial-container flex flex-col gap-[112px] w-[565px]">
                    <div class="flex flex-col gap-[30px]">
                        ...
                        <div class="relative pt-[27px] pl-[30px]">
                            <div class="absolute top-0 left-0">
                                <img src="{{ asset('assets/logo/logo-54.svg') }}" alt="icon">
                            </div>
                            <p class="font-semibold text-2xl leading-[46px] relative z-10">Lorem ipsum dolor sit, amet
                                consectetur adipisicing elit. Distinctio officia, reprehenderit magni obcaecati praesentium
                                quasi iusto rerum.</p>
                        </div>
                        <div class="flex items-center justify-between pl-[30px]">
                            <div class="flex items-center gap-6">
                                <div class="w-[60px] h-[60px] flex shrink-0 rounded-full overflow-hidden">
                                    <img src="{{ asset('assets/logo/logo-54.svg') }}" class="w-full h-full object-cover"
                                        alt="photo">
                                </div>
                                <div class="flex flex-col justify-center gap-1">
                ...
                <div class="testimonial-container flex flex-col gap-[112px] w-[565px]">
                    <div class="flex flex-col gap-[30px]">
                        ...
                        <div class="relative pt-[27px] pl-[30px]">
                            ...
                            <p class="font-semibold text-2xl leading-[46px] relative z-10">Lorem, ipsum dolor sit amet
                                consectetur adipisicing elit. Officiis quia adipisci voluptatum deleniti rerum, explicabo
                                aperiam illum porro voluptatibus qui expedita sapiente sed sequi animi!</p>
                        </div>
                        <div class="flex items-center justify-between pl-[30px]">
                            <div class="flex items-center gap-6">
                                <div class="w-[60px] h-[60px] flex shrink-0 rounded-full overflow-hidden">
                    ...
                    <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                        ...
                        <div id="accordion-faq-1" class="accordion-content hide">
                            <p class="leading-[30px] text-cp-light-grey pt-[14px]">We want to protect our and clients
                                {{ asset('assets/icons/arrow-circle-down.svg') }} that we chose the best one from Jakarta,
                                Indonesia will also protect post building finished completed ahead one.</p>
                        </div>
                    </div>
                    <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                        <button class="accordion-button flex justify-between gap-1 items-center"
        ...
        <div
            ...
            <div class="flex flex-col gap-10">
                ...
                <div class="flex items-center gap-4">
                    <a href="">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('assets/logo/logo.svg') }}" class="w-full h-full object-contain"
                                alt="youtube">
                        </div>
                    </a>
                    <a href="">
