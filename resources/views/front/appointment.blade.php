                ...
                <div class="flex flex-col gap-2 flex w-full">
                    ...
                    <div
                        ...
                        <select name="product_id" id="product_id"
                            ...
                            <option value="{{ $product->id }}" @selected($product->id == $productId)>{{ $product->name }}</option>
                            @empty
                ...
                <div class="flex items-center gap-4">
                    <a href="">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('assets/logo/logo.svg') }}" class="w-full h-full object-contain" alt="youtube">
                        </div>
                    </a>
                    <a href="">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('assets/logo/logo.svg') }}" class="w-full h-full object-contain" alt="whatsapp">
                        </div>
                    </a>
                    <a href="">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('assets/logo/logo.svg') }}" class="w-full h-full object-contain" alt="facebook">
                        </div>
                    </a>
                    <a href="">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('assets/logo/logo.svg') }}" class="w-full h-full object-contain" alt="instagram">
                        </div>
                    </a>
                </div>
            </div>
